...
const float APPS1_MIN_VOLTAGE = 2.13;
const float APPS1_MAX_VOLTAGE = 0.62;
const float APPS2_MIN_VOLTAGE = 2.80;
const float APPS2_MAX_VOLTAGE = 4.27;
const float APPS_PLAUSIBILITY_THRESHOLD = 0.25;
const float APPS_DEADZONE = 0.05;
const float BRAKE_THRESHOLD = 0.75;
