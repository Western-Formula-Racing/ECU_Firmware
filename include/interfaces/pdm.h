...
std::unordered_map<int,int>  hsdMap{
    ...
    std::array<FS_CAN::CAN_SIGNAL,7> pinStateSignals{{
        {&pinState[0], 0, 1, false, 1.0f, 0},
        {&pinState[1], 0, 1, false, 1.0f, 0},
        {&pinState[2], 0, 1, false, 1.0f, 0},
        {&pinState[3], 0, 1, false, 1.0f, 0},
        {&pinState[4], 0, 1, false, 1.0f, 0},
        {&pinState[5], 0, 1, false, 1.0f, 0},
        {&pinState[6], 0, 1, false, 1.0f, 0}
    }};
